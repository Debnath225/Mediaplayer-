document.addEventListener('DOMContentLoaded', () => {
    ...
    const DEFAULT_ALBUM_ART = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAEERJ0NNdpsJFUwVUTHwjTn43cYHMVkR3_g&usqp=CAU'; // A simple default image
    ...
    function loadSong(song) {
        ...
        albumArt.onerror = () => { albumArt.src = DEFAULT_ALBUM_ART; }; // Fallback if image link is broken
    ...
    function renderPlaylist() {
        ...
        songs.forEach((song, index) => {
            ...
            li.innerHTML = `
                <img src="${song.imageSrc || DEFAULT_ALBUM_ART}" alt="${song.title}" class="playlist-item-art" onerror="this.src='${DEFAULT_ALBUM_ART}'">
